...
固定の収入   ¥280,000
固定の支出   ¥188,000
返済に回せる  ¥92,000     ← 固定収入 − 固定支出

目標 ¥120,000 に対して ¥28,000 足りません。

  副業などで稼ぐ    ¥28,000   1日あたり ¥933・週 ¥6,533
  固定支出を減らす  ¥28,000   いまの固定支出の 14.9%
```
...
検証は `npm test`（272件）で、日割り計算そのもの・返済の充当順序・取り消しの復元に加えて、
